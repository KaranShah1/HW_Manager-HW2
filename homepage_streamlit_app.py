...
with st.sidebar:
    selected_page = option_menu(
        "HW Manager",
        ["First Homework", "Second Homework", "Third Homework", "Third Homework Retry", "Fourth Homework", "Fourth Homework Retry", "Fifth Homework","trialll","Fifth Homework Retry", "Sixth Homework"],
        icons=['book', 'book', 'book', 'book', 'book','book','book','book','book'],
        menu_icon="cast", 
        default_index=0,
    )
...
elif selected_page == "Fourth Homework Retry":
    st.title("HW - 4")
    # Execute the hw4.py code
    exec(open("hw4_retry.py").read())

elif selected_page == "Fifth Homework":
    st.title("HW - 5")
    # Execute the hw5.py code
    exec(open("hw5.py").read())

elif selected_page == "trialll":
    st.title("HW - 5")
    # Execute the hw5.py code
    exec(open("HW5 (1).py.py").read())
