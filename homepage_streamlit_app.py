...
with st.sidebar:
    selected_page = option_menu(
        "HW Manager",
        ["First Homework", "Second Homework", "Third Homework", "Third Homework Retry", "Fourth Homework", "Fourth Homework Retry", "Fifth Homework","Fifth Homework Retry", "Sixth Homework"],
