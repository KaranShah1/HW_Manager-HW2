...
# Append the combined documents to the messages for context
context_message = {"role": "system", "content": f"Here are the documents to refer:\n\n{combined_documents}"}
st.session_state.messages = st.session_state.get('messages', []) + [context_message]
